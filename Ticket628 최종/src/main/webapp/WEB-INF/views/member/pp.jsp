...
<!--총상품금액 --> <fmt:formatNumber  value="${totalGoodsPrice}" type="number" var="total_goods_price" />
				         ${total_goods_price}원
	          </p>
	       ...
	       <td>
<!--총 배송비 -->	   <p id="p_totalDeliveryPrice">${totalDeliveryPrice }원  </p>
...
<!--총 할인금액 -->  
	        ...
	        <!--  <fmt:formatNumber  value="${totalDiscountedPrice}" type="number" var="totalDiscountedPrice" />
	         ...
	         <fmt:formatNumber var="total_discount" value="${total_goods_price-totalDiscountedPrice}" pattern="#,###"/>
				         ${total_discount}원
	         </p>
	       
	         <input id="h_totalSalesPrice"type="hidden" value="${total_discount}" />
	        -->
	       </td>
	       <td>  
...
<!-- 할인 후 최종금액   
	       <td>
	          ...
	          <fmt:formatNumber  value="${totalDiscountedPrice+totalDeliveryPrice}" type="number" var="total_price" pattern="#,###" />
	            ${total_price}원
	          </p>
	          <input id="h_final_totalPrice" type="hidden" value="${total_price}" />
	       </td>
	       -->    
	        <td>
             <p id="p_final_totalPrice">
             <fmt:formatNumber  value="${totalGoodsPrice+totalDeliveryPrice-totalDiscountPrice}" type="number" var="total_price" />
               ${total_price}원
             </p>
             <input id="h_final_totalPrice" type="hidden" value="${totalGoodsPrice+totalDeliveryPrice-totalDiscountPrice}" />
          </td>
		</tr>
		</tbody>
	</table>
