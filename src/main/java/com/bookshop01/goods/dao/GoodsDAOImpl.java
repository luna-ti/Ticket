...
//상태별 상품목록(신간...)
 ...
 //장르별 상품목록(it..)  
	@Override
	public List<GoodsVO> selectGoodsList2(String goodsSort) throws DataAccessException {
		List<GoodsVO> goodsList2=(ArrayList)sqlSession.selectList("mapper.goods.selectGoodsList2",goodsSort);
			return goodsList2;
		}
